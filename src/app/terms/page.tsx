...
export default function TermsPage() {
  return (
    <InnerPageShell eyebrow="Legal" title="Terms" description={routePageContent.terms.description} ctaHref="/contact" ctaLabel="Request Audit">
      <section className="mx-auto max-w-4xl px-5 pb-16 text-sm leading-7 text-[#d6c8ae] md:px-6">
        <div className="rounded-[2rem] border border-[rgba(201,155,71,.25)] bg-white/[.035] p-6 md:p-8">
          ...
          <p className="mt-4">This website provides information about TrustFirst Solutions services and ways to request a growth audit or service enquiry.</p>
          <h2 className="mt-8 text-2xl font-black text-[#f8efd9]">Service discussions</h2>
          <p className="mt-4">Submitting an enquiry starts a conversation. Service scope, timeline and commercial terms should be confirmed separately before work begins.</p>
