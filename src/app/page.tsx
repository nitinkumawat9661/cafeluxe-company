...
<JsonLd/>
<header className="sticky top-0 z-[90000] border-b border-white/10 bg-[#050504]/95"><nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5"><b className="text-xl"><span><span className="trust-shimmer">Trust</span>First Solutions</span></b><a href="#contact" className="rounded-full border border-[rgba(201,155,71,.45)] px-5 py-3 text-sm font-black">Start Project</a></nav></header>
...
<div className="mx-auto h-64 w-44 rotate-0 rounded-[1.7rem] border border-white/20 bg-[#090704] p-5 shadow-2xl md:h-80 md:w-56 md:rotate-6 md:rounded-[2rem] md:p-6"><b className="text-[var(--gold)]"><span className="trust-shimmer">Trust</span>First Solutions</b><h2 className="mt-10 text-xl font-black md:mt-16 md:text-2xl">Let&apos;s build something amazing.</h2><button className="mt-8 rounded-full bg-[var(--gold)] px-4 py-3 font-black text-black">Start a conversation →</button></div>
...
<div className="hidden absolute bottom-16 right-8 rounded-2xl border border-[rgba(201,155,71,.35)] bg-black/50 p-5 md:block"><b className="text-[var(--gold)]">Email Us</b><p>hello@trustfirstsolutions.in</p></div>
</div>
</section>
