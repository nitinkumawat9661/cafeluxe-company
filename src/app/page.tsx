...
const contacts=[["Phone / WhatsApp","+91 74148 53321","Mon-Fri: 9:00 AM - 6:00 PM"],["Email Us","hello@trustforge.in","We reply within 24 hours"],["Our Office","Sikar, Rajasthan","Remote projects across India"],["Business Hours","Mon-Fri: 8:00 AM - 6:00 PM","Saturday by appointment"]];
...
<JsonLd/>
<header className="sticky top-0 z-[90000] border-b border-white/10 bg-[#050504]/95"><nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5"><b className="text-xl"><span className="text-[var(--gold)]">TrustForge</span></b><a href="#contact" className="rounded-full border border-[rgba(201,155,71,.45)] px-5 py-3 text-sm font-black">Start Project</a></nav></header>
...
<div className="mx-auto h-64 w-44 rotate-0 rounded-[1.7rem] border border-white/20 bg-[#090704] p-5 shadow-2xl md:h-80 md:w-56 md:rotate-6 md:rounded-[2rem] md:p-6"><b className="text-[var(--gold)]">TrustForge</b><h2 className="mt-10 text-xl font-black md:mt-16 md:text-2xl">Let&apos;s build something amazing.</h2><button className="mt-8 rounded-full bg-[var(--gold)] px-4 py-3 font-black text-black">Start a conversation →</button></div>
...
<div className="hidden absolute bottom-16 right-8 rounded-2xl border border-[rgba(201,155,71,.35)] bg-black/50 p-5 md:block"><b className="text-[var(--gold)]">Email Us</b><p>hello@trustforge.in</p></div>
</div>
</section>
...
<footer className="border-t border-white/10 px-5 py-10 md:px-6"><div className="mx-auto grid max-w-6xl gap-8 text-sm text-[#d6c8ae] md:grid-cols-4"><div><b className="text-xl text-white"><span className="text-[var(--gold)]">TrustForge</span></b><p className="mt-3">Premium websites, apps and software systems.</p></div><div><b>Quick Links</b><p className="mt-3">Home<br/>Services<br/>Pricing<br/>Contact</p></div><div><b>Services</b><p className="mt-3">Website Design<br/>App Development<br/>Custom Software<br/>UI/UX Design</p></div><div><b>Contact</b><p className="mt-3">+91 74148 53321<br/>hello@trustforge.in</p></div></div><p className="mt-8 text-center text-sm text-[#d6c8ae]">© 2026 TrustForge. All rights reserved.</p></footer>
<FloatingPreferences/>
</main>
}
