export function WhatsAppFloating() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 inline-flex h-14 w-14 items-center justify-center rounded-full border border-[rgba(201,155,71,.35)] bg-[var(--gold)] text-black shadow-[0_0_30px_rgba(201,155,71,.35)] transition hover:scale-105 motion-safe:animate-bounce motion-reduce:animate-none"
    >
