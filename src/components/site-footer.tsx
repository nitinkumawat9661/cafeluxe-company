...
export function SiteFooter() {
  return (
    <footer className="border-t border-white/10 px-5 py-10 md:px-6">
      <div className="mx-auto grid max-w-6xl gap-8 text-sm text-[#d6c8ae] md:grid-cols-[1.3fr_repeat(4,1fr)]">
        <div>
          <b className="text-xl text-white">
            <span>
              <span className="trust-shimmer">Trust</span>First Solutions
            </span>
          </b>
          <p className="mt-3 max-w-xs">Premium websites, apps and software systems.</p>
          <div className="mt-4 grid gap-3">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-[rgba(201,155,71,.3)] px-4 py-3 text-[#f7ecd2]"
            >
              Instagram <ArrowUpRight size={15} strokeWidth={1.9} />
            </a>
          </div>
        </div>
      ...
      <p className="mt-8 text-center text-sm text-[#d6c8ae]">© 2026 TrustFirst Solutions. All rights reserved.</p>
    </footer>
  );
}
